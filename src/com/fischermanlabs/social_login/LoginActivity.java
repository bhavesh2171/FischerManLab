...
public class LoginActivity extends AccountAuthenticatorActivity {
	...
	private void finishConfirmCredentials(boolean result) {
		final Account account = new Account(mUserEmail, KinveyUserLogin.ACCOUNT_TYPE);
		mAccountManager.setPassword(account, mPassword);
		mAccountManager.setUserData(account, KinveyUserLogin.LOGIN_TYPE_KEY, PARAM_LOGIN_TYPE_KINVEY);
	...
	private void finishLogin(String authToken) {
		...
		if (mRequestNewAccount) {
			...
			userData.putString(KinveyUserLogin.LOGIN_TYPE_KEY, PARAM_LOGIN_TYPE_KINVEY);
	...
	public void userLogin() {
		kinveyClient.user().login(mEditUserEmail.getText().toString(), mEditPassword.getText().toString(), new KinveyUserCallback() {
            ...
            public void onSuccess(User u) {
                ...
                LoginActivity.this.startActivity(new Intent(LoginActivity.this, FischerLabActivity.class));
                LoginActivity.this.finish();
            }
