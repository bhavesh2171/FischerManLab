 ...
 * 
 */
package com.fischermanlabs.social_login;
...
import com.facebook.*;
import com.fischermanlabs.FischerLabActivity;
import com.fischermanlabs.R;
import com.fischermanlabs.kinvey.KinveyUserLogin;
...
public class FacebookLoginActivity extends AccountAuthenticatorActivity {
	 ...
	 */
	private static final String FB_APP_ID = "263296673845433";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		kinveyClient = ((KinveyUserLogin) getApplication()).getKinveyService();
	...
	private void loginFacebookKinveyUser(final ProgressDialog progressDialog, String accessToken) {
		...
		kinveyClient.user().loginFacebook(accessToken, new KinveyUserCallback() {
            ...
            public void onSuccess(User u) {
                ...
                FacebookLoginActivity.this.startActivity(new Intent(FacebookLoginActivity.this, FischerLabActivity.class));
	...
	private void finishConfirmCredentials(boolean result, String authKey, String password) {
		final Account account = new Account(authKey, KinveyUserLogin.ACCOUNT_TYPE);
		mAccountManager.setPassword(account, password);
		mAccountManager.setUserData(account, KinveyUserLogin.LOGIN_TYPE_KEY, PARAM_LOGIN_TYPE_FACEBOOK);
	...
	private void finishLogin(String authToken, String password) {
		final Account account = new Account(authToken, KinveyUserLogin.ACCOUNT_TYPE);
		if (mRequestNewAccount) {
			Bundle userData = new Bundle();
			userData.putString(KinveyUserLogin.LOGIN_TYPE_KEY, PARAM_LOGIN_TYPE_FACEBOOK);
		...
		intent.putExtra(AccountManager.KEY_ACCOUNT_TYPE, KinveyUserLogin.ACCOUNT_TYPE);
